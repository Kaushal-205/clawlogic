...
export const predictionMarketHookAbi = [
  ...
  {
    type: 'function',
    name: 'getMarketFeeInfo',
    inputs: [{ name: 'marketId', type: 'bytes32', internalType: 'bytes32' }],
    outputs: [
      { name: 'creator', type: 'address', internalType: 'address' },
      { name: 'creatorFeesAccrued', type: 'uint256', internalType: 'uint256' },
      { name: 'protocolFeesAccrued', type: 'uint256', internalType: 'uint256' },
      { name: 'protocolFeeBps', type: 'uint16', internalType: 'uint16' },
      { name: 'creatorFeeBps', type: 'uint16', internalType: 'uint16' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    outputs: [
      { name: 'creatorClaimable', type: 'uint256', internalType: 'uint256' },
      { name: 'protocolClaimable', type: 'uint256', internalType: 'uint256' },
    ],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'marketId', type: 'bytes32', indexed: true, internalType: 'bytes32' },
      { name: 'creator', type: 'address', indexed: true, internalType: 'address' },
      { name: 'protocolRecipient', type: 'address', indexed: true, internalType: 'address' },
  ...
  { type: 'error', name: 'InsufficientTradeAmount', inputs: [] },
