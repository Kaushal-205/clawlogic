...
#
# Usage: create-market.sh <outcome1> <outcome2> <description> [reward] [bond]
#
# Arguments:
...
if [ $# -lt 3 ]; then
  echo '{"success": false, "error": "Usage: create-market.sh <outcome1> <outcome2> <description> [reward] [bond]"}' >&2
  exit 1
fi
